...
const chordTypes = [
  ...
  new ChordType("maj11", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[5], intervals[7], intervals[11]], ["major 11th"]),
  ...
  new ChordType("7b5b9", twelveTET, [intervals[0], intervals[1], intervals[4], intervals[6], intervals[10]], ["dominant 7th, flat 5th, flat 9th", "7(b5,b9)", "7(-5,-9)"]),
  new ChordType("7b5#9", twelveTET, [intervals[0], intervals[3], intervals[4], intervals[6], intervals[10]], ["dominant 7th, flat 5th, sharp 9th", "7(b5,#9)", "7(-5,+9)"]),
  new ChordType("7#5b9", twelveTET, [intervals[0], intervals[1], intervals[4], intervals[8], intervals[10]], ["dominant 7th, sharp 5th, flat 9th", "7(#5,b9)", "7(+5,-9), +7b9"]),
