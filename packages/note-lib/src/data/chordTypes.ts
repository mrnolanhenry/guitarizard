...
const chordTypes = [
  ...
  // new ChordType("7b9 add#11", twelveTET, [intervals[0], intervals[1], intervals[4], intervals[6], intervalsPriority2[7], intervals[10]], ["dominant flat ninth, added sharp 11th"]),
