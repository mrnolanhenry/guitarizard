...
const chordTypes = [
  ...
  new ChordType("6", twelveTET, [intervals[0], intervals[4], intervals[7], intervals[9]]),
  new ChordType("7", twelveTET, [intervals[0], intervals[4], intervals[7], intervals[10]], ["dominant 7th"]),
  new ChordType("maj7", twelveTET, [intervals[0], intervals[4], intervals[7], intervals[11]], ["major 7th", "M7"]),
  new ChordType("9", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[7], intervals[10]]),
  new ChordType("maj9", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[7], intervals[11]], ["major 9th", "M9", "maj7(9)"]),
  ...
  new ChordType("13", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[7], intervals[9], intervals[10]]),
  new ChordType("maj13", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[7], intervals[9], intervals[11]], ["major 13th", "M13", "maj7(9,13)", "maj7(6/9)", "maj7(6add9)"]),
  new ChordType("m6", twelveTET, [intervals[0], intervals[3], intervals[7], intervals[9]]),
  new ChordType("m7", twelveTET, [intervals[0], intervals[3], intervals[7], intervals[10]], ["minor 7th", "min7"]),
  new ChordType("m9", twelveTET, [intervals[0], intervals[2], intervals[3], intervals[7], intervals[10]]),
  new ChordType("m11", twelveTET, [intervals[0], intervals[2], intervals[3], intervals[5], intervals[7], intervals[10]]),
  new ChordType("m13", twelveTET, [intervals[0], intervals[2], intervals[3], intervals[5], intervals[7], intervals[9], intervals[10]]),
  new ChordType("m(maj7)", twelveTET, [intervals[0], intervals[3], intervals[7], intervals[11]], ["m (maj7)", "mmaj7", "m maj7"]),
  ...
  new ChordType("6add9", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[7], intervals[9]], ["6/9"]),
  new ChordType("7sus4", twelveTET, [intervals[0], intervals[5], intervals[7], intervals[10]], ["dominant 7th suspended 4th"]),
  ...
  new ChordType("9sus4", twelveTET, [intervals[0], intervals[2], intervals[5], intervals[10]]),
  ...
  new ChordType("dim7", twelveTET, [intervals[0], intervals[3], intervals[6], intervals[9]], ["diminished 7th", "7dim"]),
  ...
  new ChordType("m7b5", twelveTET, [intervals[0], intervals[3], intervals[6], intervals[10]]),
  new ChordType("m7#5", twelveTET, [intervals[0], intervals[3], intervals[8], intervals[10]]),
  new ChordType("7#5", twelveTET, [intervals[0], intervals[4], intervals[8], intervals[10]]),
  ...
  new ChordType("9#5", twelveTET, [intervals[0], intervals[2], intervals[4], intervals[8], intervals[10]], ["dominant 9th, sharp 5th", "7(#5,9)", "9+5"]),
