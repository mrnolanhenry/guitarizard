...
tap.test('class Key', function (t) {
    ...
    console.log('Bully');
    console.log(BbLydian.getEquivKeys());
    console.log('Bully');
    ...
    //     new Key(new Note('A'), new Scale('neapolitan minor', diatonic, [0, 1, 3, 5, 7, 8, 10, 12])),
    //     new Key(new Note('Bb'), new Scale('lydian', diatonic, [0, 2, 4, 6, 7, 9, 11, 12])),
    //     new Key(new Note('C'), new Scale('mixolydian', diatonic, [0, 2, 4, 5, 7, 9, 10, 12])),
    //     new Key(new Note('D'), new Scale('aeolian', diatonic, [0, 2, 3, 5, 7, 8, 10, 12])),
    //     new Key(new Note('E'), new Scale('locrian', diatonic, [0, 1, 3, 5, 6, 8, 10, 12])),
    //     new Key(new Note('F'), new Scale('ionian', diatonic, [0, 2, 4, 5, 7, 9, 11, 12])),
    //     new Key(new Note('F'), new Scale('major', diatonic, [0, 2, 4, 5, 7, 9, 11, 12])),
    //     new Key(new Note('G'), new Scale('dorian', diatonic, [0, 2, 3, 5, 7, 9, 10, 12]))
