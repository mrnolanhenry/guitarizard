...
const a_440_fr3qu3ncy_list: MITNote[] = [
  ...
  { note: "C#2/Db2", frequency_hz: 69.3, wavelength_cm: 497.87 },
  ...
  { note: "F#2/Gb2", frequency_hz: 92.5, wavelength_cm: 372.98 },
  { note: "G2", frequency_hz: 98.0, wavelength_cm: 352.04 },
  { note: "G#2/Ab2", frequency_hz: 103.83, wavelength_cm: 332.29 },
  { note: "A2", frequency_hz: 110.0, wavelength_cm: 313.64 },
  ...
  { note: "F#3/Gb3", frequency_hz: 185.0, wavelength_cm: 186.49 },
  { note: "G3", frequency_hz: 196.0, wavelength_cm: 176.02 },
  { note: "G#3/Ab3", frequency_hz: 207.65, wavelength_cm: 166.14 },
  { note: "A3", frequency_hz: 220.0, wavelength_cm: 156.82 },
  ...
  { note: "G4", frequency_hz: 392.0, wavelength_cm: 88.01 },
  { note: "G#4/Ab4", frequency_hz: 415.3, wavelength_cm: 83.07 },
  { note: "A4", frequency_hz: 440.0, wavelength_cm: 78.41 },
  ...
  { note: "A5", frequency_hz: 880.0, wavelength_cm: 39.2 },
  { note: "A#5/Bb5", frequency_hz: 932.33, wavelength_cm: 37.0 },
  { note: "B5", frequency_hz: 987.77, wavelength_cm: 34.93 },
  { note: "C6", frequency_hz: 1046.5, wavelength_cm: 32.97 },
  ...
  { note: "F6", frequency_hz: 1396.91, wavelength_cm: 24.7 },
  { note: "F#6/Gb6", frequency_hz: 1479.98, wavelength_cm: 23.31 },
  { note: "G6", frequency_hz: 1567.98, wavelength_cm: 22.0 },
  { note: "G#6/Ab6", frequency_hz: 1661.22, wavelength_cm: 20.77 },
  { note: "A6", frequency_hz: 1760.0, wavelength_cm: 19.6 },
  { note: "A#6/Bb6", frequency_hz: 1864.66, wavelength_cm: 18.5 },
  { note: "B6", frequency_hz: 1975.53, wavelength_cm: 17.46 },
  { note: "C7", frequency_hz: 2093.0, wavelength_cm: 16.48 },
  ...
  { note: "G7", frequency_hz: 3135.96, wavelength_cm: 11.0 },
  { note: "G#7/Ab7", frequency_hz: 3322.44, wavelength_cm: 10.38 },
  { note: "A7", frequency_hz: 3520.0, wavelength_cm: 9.8 },
  ...
  { note: "G8", frequency_hz: 6271.93, wavelength_cm: 5.5 },
  { note: "G#8/Ab8", frequency_hz: 6644.88, wavelength_cm: 5.19 },
  { note: "A8", frequency_hz: 7040.0, wavelength_cm: 4.9 },
...
function findMitNote(
  a_fr3quency_list: MITNote[],
  noteName: string,
  octave: number,
): MITNote | undefined {
  return a_fr3quency_list.find((value) =>
    new RegExp(`${noteName}${octave}`).test(value.note),
  );
}
...
const stopNote = (note: Note) => {
  ...
  if (mitNote) {
    const active_note = active_notes[note.id];
...
const FretSegment = (props: FretSegmentProps) => {
  ...
  const stringLineStyle: CSSProperties = {
    backgroundColor: theme.swatch.base0E,
  };
