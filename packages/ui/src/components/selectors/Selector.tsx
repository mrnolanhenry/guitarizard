...
import { AutocompleteChangeDetails, AutocompleteChangeReason, AutocompleteInputChangeReason, AutocompleteRenderOptionState, FilterOptionsState, TextField } from "@mui/material";
...
const Selector = <T,> (props: ISelectorProps<T>) => {
	...
	const [inputVal, setInputVal] = useState(!!activeItem && !!getDisplay ? getDisplay(activeItem as T) : "");
